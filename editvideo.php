<?php
    ...
    if($_SESSION['gm_7548_li'] == "" || count($_SESSION["gm_7548_li"]) <= 0 ){
        ...
        $server1_name = $video["server1_name"];
        $server1_link = $video["server1_link"];
        $server2_name = $video["server2_name"];
        $server2_link = $video["server2_link"];
        $server3_name = $video["server3_name"];
        $server3_link = $video["server3_link"];
        $server4_name = $video["server4_name"];
        $server4_link = $video["server4_link"];
        $server5_name = $video["server5_name"];
        $server5_link = $video["server5_link"];
        $server6_name = $video["server6_name"];
        $server6_link = $video["server6_link"];
        ...
        if(isset($_POST['edit'])){
            ...
            $stmt = "UPDATE `videos` 
                    SET `series_id`=:series_id,`title`=:title,
            ...
            $status = "Video is Edited!";

            // Re-retireve updated data from db
            $stmt = 'SELECT * FROM `videos` WHERE `id` = :video_id';
            $sth = $db->prepare($stmt , array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
            $sth->execute(array(':video_id' => $video_id));
            $video = $sth->fetch();
    ...
    <div class="container">
        <form action="" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="server1_name" class="form-control" value="<?=$server1_name;?>" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 1 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server1_link" class="form-control" value="<?=$server1_link;?>" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 2 Name</label>
                <div class="col-sm-10">
                    <input type="text" name="server2_name" class="form-control" value="<?=$server2_name;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 2 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server2_link" class="form-control" value="<?=$server2_link;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 3 Name</label>
                <div class="col-sm-10">
                    <input type="text" name="server3_name" class="form-control" value="<?=$server3_name;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 3 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server3_link" class="form-control" value="<?=$server3_link;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 4 Name</label>
                <div class="col-sm-10">
                    <input type="text" name="server4_name" class="form-control" value="<?=$server4_name;?>" >
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 4 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server4_link" class="form-control" value="<?=$server4_link;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 5 Name</label>
                <div class="col-sm-10">
                    <input type="text" name="server5_name" class="form-control" value="<?=$server5_name;?>" >
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 5 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server5_link" class="form-control" value="<?=$server5_link;?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 6 Name</label>
                <div class="col-sm-10">
                    <input type="text" name="server6_name" class="form-control" value="<?=$server6_name;?>" >
                </div>
            </div>
            <div class="form-group row">
                <label for="" class="col-sm-2 col-form-label">Server 6 Link</label>
                <div class="col-sm-10">
                    <input type="text" name="server6_link" class="form-control" value="<?=$server6_link;?>">
                </div>
            </div>
            <button type="submit" name="edit" class="btn btn-primary col-sm-5 offset-sm-1">Add</button>
